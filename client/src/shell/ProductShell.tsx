...
/**
 * The GitHub mark, inline. The brands icon set is 6.2MB to carry one glyph, and
 * this is the only glyph Drift takes from it. The solid set stays a dependency:
 * 21 icons earn it.
 *
 * Path from the official GitHub logo, MIT-licensed via Font Awesome's free set.
 */
function GitHubMark() {
  return (
    <svg viewBox="0 0 496 512" width="1em" height="1em" fill="currentColor" aria-hidden="true">
