    ...
    <Table head={["Preview", "Value", "Tags", "Uses"]}>
      {shadow.map((sh, i) => (
        <tr key={i}>
          ...
          <td className={`${shared.valueCell} ${styles.valueCellWrap}`} title={sh.value}>
            {sh.value}
          </td>
    ...
    <Table head={["Preview", "Value", "Tags", "Uses"]}>
      {gradients.map((g, i) => (
        <tr key={i}>
          ...
          <td className={`${shared.valueCell} ${styles.valueCellWrap}`} title={g.value}>
            {g.value}
          </td>
      ...
      <Table head={["Preview", "Easing", "Tags", "Uses"]} className={styles.motionTable}>
        {motion.easings.map((e) => (
          <tr key={e.value}>
            ...
            <td className={`${shared.valueCell} ${styles.valueCellWrap}`}>{e.value}</td>
